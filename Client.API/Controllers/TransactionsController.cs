    ...
    public class TransactionsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTransactions([FromQuery] TransactionsFilter filter)
        {
            try
            {
                ...
                var query = _context.Transactions
                    ...
                    .Where(t => t.ChargePoint.CompanyId == companyId);
                ...
                var transactions = await query
                    ...
                    .Select(t => new
                    {
                        ...
                        // Расчетный доход (в реальном проекте нужна таблица тарифов)
                        Revenue = t.GetEnergyConsumed() * 0.25 // 0.25 руб/кВт·ч
                    })
                    .ToListAsync();
            ...
            {
                _logger.LogError(ex, "Error getting transactions for company");
        ...
        public async Task<IActionResult> GetTransaction(int id)
        {
            try
            {
                ...
                var transaction = await _context.Transactions
                    ...
                    .FirstOrDefaultAsync(t => t.Id == id && t.ChargePoint.CompanyId == companyId);
                ...
                return Ok(new
                {
                    ...
                    Revenue = transaction.GetEnergyConsumed() * 0.25, // Расчетный доход
        ...
        public async Task<IActionResult> GetTransactionsStats([FromQuery] DateTime? startDate, [FromQuery] DateTime? endDate)
        {
            try
            {
                ...
                var query = _context.Transactions
                    .Where(t => t.ChargePoint.CompanyId == companyId &&
                               t.StartTimestamp >= start && t.StartTimestamp <= end);
                ...
                var stats = new
                {
                    ...
                    TotalRevenue = (await query
                        .Where(t => t.MeterStop.HasValue && t.MeterStart.HasValue)
                        .SumAsync(t => (double?)(t.MeterStop - t.MeterStart)) ?? 0) * 0.25,
            ...
            {
                _logger.LogError(ex, "Error getting transactions stats for company");
                return StatusCode(500, new { Error = "Internal server error" });
            }
        }
